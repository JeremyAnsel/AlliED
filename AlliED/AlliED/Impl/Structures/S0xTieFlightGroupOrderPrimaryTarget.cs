...
internal class S0xTieFlightGroupOrderPrimaryTarget
{
    ...
    public static S0xTieFlightGroupOrderPrimaryTarget FromByteArray(byte[] array)
    {
        ...
        var target = new S0xTieFlightGroupOrderPrimaryTarget();
        target.ClassA = (TieClassEnum)array[0x00];
        target.ParameterA = array[0x01];
        target.ClassB = (TieClassEnum)array[0x02];
    ...
    public byte[] ToByteArray()
    {
        ...
        array[0x01] = ParameterA;
        array[0x02] = (byte)ClassB;
